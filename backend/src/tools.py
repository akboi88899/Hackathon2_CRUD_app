    ...
    try:
        ...
        with Session(engine) as db:
            ...
            if recurrence:
                ...
                elif recurrence_lower in ["weekly", "every_week"]:
                    recurrence_type = "weekly"
                elif recurrence_lower == "monthly":
                    recurrence_type = "monthly"
                elif "every_" in recurrence_lower:
                    # Handle every_monday, every_tuesday, etc.
                    day = recurrence_lower.replace("every_", "")
                    recurrence_type = "weekly"
                    day_mapping = {
                        "monday": "Mon", "tuesday": "Tue", "wednesday": "Wed",
                        "thursday": "Thu", "friday": "Fri", "saturday": "Sat", "sunday": "Sun"
                    }
                    recurrence_days = day_mapping.get(day, "Mon")
    ...
    try:
        ...
        with Session(engine) as db:
            ...
            if recurrence is not None:
                # Parse recurrence pattern
                task.is_recurring = True if recurrence else False
                if recurrence:
                    recurrence_lower = recurrence.lower()
                    ...
                    if recurrence_lower == "daily":
                        ...
                        task.recurrence_days = day_mapping.get(day, "Mon")
